...
- If you absolutely want to do some analyses in Excel ^[{{< fa heart >}} In fact, do not use Excel {{< fa heart >}}], make a copy of the file and do your calculations and graphs in the copy.
