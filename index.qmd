...
![](img/ai/geotiff.jpeg){width=600 fig-alt="AI generated image of a computer screen showing some scifi images."}
...
![Source: <a href="https://bit.ly/2M8cViI">https://bit.ly/2M8cViI</a>](img/screenshots/python_file_naming.png){fig-alt="Screenshot of a scientific taking his heaad in his hands and sitting at a desk."}
...
::: {.center-align}
![Original image from: Bhandari Neupane, J. et al. Characterization of Leptazolines A-D, Polar Oxazolines from the Cyanobacterium Leptolyngbya sp., Reveals a Glitch with the “Willoughby-Hoye” Scripts for Calculating NMR Chemical Shifts. Org. Lett. 21, 8449-8453 (2019).](img/excalidraw/files_sorting2.png){width=60% fig-alt="Image showing how files are sorted in a file explorer on Windows and Linux."}
...
![](img/screenshots/data_rectangle1.png){fig-alt="Data in a computer spreadsheet program with one block of data."}
...
![](img/screenshots/data_rectangle3.png){.r-stretch fig-alt="Data in a computer spreadsheet program. Data is not arranged in a rectangle table and there is a geographic placed inside the sheet."}
...
![](img/ai/hd_fail.jpeg){width=800 fig-alt="AI generated image of a hard drive failing with a person crying because of loosing data."}
